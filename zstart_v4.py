...
print tf_hel_1[0]
print tfref_hel_1[0]
tfmatrix = numpy.array(tf_hel_1) == numpy.array(tfref_hel_1)
...
i = 0
for i in range(len_frame):
	tf_hel = tf_hel_1[i].astype(int)
	tf_refhel = tfref_hel_1[i].astype(int)
	...
	toedit[i][X,Y] = 0 #this should work in THEORY
	toedit[i][Xref,Yref] = 0
	i = i + 1
print toedit[0]
print toedit[50]
...
#### Now, do it for every frame that's here

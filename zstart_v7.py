...
u = mda.Universe('/home/droofasa/Desktop/PRB-0-HIE_ProteinOnly.pdb', '/home/droofasa/Desktop/PRB-0-protein-025.dcd')
ref = mda.Universe('/home/droofasa/Desktop/PDB_000-9184.pdb')
...
#ax.plot(xaxis, Z_hel12,'b')
ax.plot(xaxis, Q_hel12, 'b')
ax.set(xlabel='frame', ylabel='fraction of native contacts', title='PRB-025 Native Contacts')
ax.set_ylim(0, 1.0)
f.show()
plt.pause(30)
